<p align="center">
  <a href="../../../../SmallK111407/"><img src="./onlyJS.png" width="100%" height="100%" alt="onlyJS"></a>
</p>
...
手动下载 Zip 压缩包，解压后将对应`.js`文件放入`机器人根目录/plugins/example`即可
...
我们可将其中 onlyJS 后面的**blob**改成**raw**即可直接展示源代码方便复制

</details>

</details>

## 插件路径(使用安装方式 1 或 3 的时候可查看)
